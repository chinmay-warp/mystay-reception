  ...
  return (
    ...
    >
      <input
        type={type}
        id={id}
        className="peer bg-gray-50 border border-gray-300 text-gray-900 text-[12px] rounded-lg h-[40px] placeholder-transparent outline-none focus:ring-primary focus:border-primary block w-full p-2 "
